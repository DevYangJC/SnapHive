...
import com.yjc.snaphive.model.dto.spaceuser.SpaceUserAuditRequest;
import com.yjc.snaphive.model.dto.spaceuser.SpaceUserJoinRequest;
import com.yjc.snaphive.model.dto.spaceuser.SpaceUserQueryRequest;
...
import com.yjc.snaphive.model.vo.SpaceUserVO;
...
import com.yjc.snaphive.mapper.SpaceUserMapper;
...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    public boolean auditSpaceUser(SpaceUserAuditRequest spaceUserAuditRequest, User loginUser) {
        ...
        ThrowUtils.throwIf(targetUser == null, ErrorCode.NOT_FOUND_ERROR, "未找到该用户的申请记�?);

        // 校验被审核用户不是管理员
        ThrowUtils.throwIf("admin".equals(targetUser.getSpaceRole()),
                ErrorCode.OPERATION_ERROR, "不能审核管理�?);
    ...
    public boolean joinSpace(SpaceUserJoinRequest spaceUserJoinRequest, User loginUser) {
        ...
        if (existSpaceUser != null) {
            ...
            if (existSpaceUser.getStatus() == 0) {
                throw new BusinessException(ErrorCode.OPERATION_ERROR, "您的申请正在审核�?);
            }
        }
        ...
        spaceUser.setStatus(0);  // 设置为待审核状�?
        spaceUser.setSpaceRole("viewer");  // 默认设置为查看者角�?
