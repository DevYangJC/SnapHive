...
import com.yjc.snaphive.esdao.EsSpaceDao;
...
import com.yjc.snaphive.model.dto.space.SpaceAddRequest;
import com.yjc.snaphive.model.dto.space.SpaceQueryRequest;
...
import com.yjc.snaphive.model.enums.SpaceLevelEnum;
import com.yjc.snaphive.model.enums.SpaceRoleEnum;
import com.yjc.snaphive.model.enums.SpaceTypeEnum;
import com.yjc.snaphive.model.vo.SpaceVO;
import com.yjc.snaphive.model.vo.UserVO;
import com.yjc.snaphive.service.SpaceService;
import com.yjc.snaphive.mapper.SpaceMapper;
import com.yjc.snaphive.service.SpaceUserService;
...
public class SpaceServiceImpl extends ServiceImpl<SpaceMapper, Space>
            ...
            Long newSpaceId = transactionTemplate.execute(status -> {
                ...
                if (SpaceTypeEnum.PRIVATE.getValue() == space.getSpaceType()) {
                    boolean exists = this.lambdaQuery()
                            ...
                            .exists();
                    ThrowUtils.throwIf(exists, ErrorCode.OPERATION_ERROR, "每个用户只能创建一个私有空�?);
                }
                // 判断公共空间数量是否超限
                    ...
                    long count = this.lambdaQuery()
                            ...
                            .count();
                    ThrowUtils.throwIf(count >= 10, ErrorCode.OPERATION_ERROR, "每个用户最多只能创�?0个团队空�?);
                }
    ...
    public void validSpace(Space space, boolean add) {
        ...
        if (spaceLevel != null && spaceLevelEnum == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "空间级别不存�?);
        }
        // 修改数据时，空间类别进行校验
        if (spaceType != null && spaceTypeEnum == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "空间类别不存�?);
        }
    }
