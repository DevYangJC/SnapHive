...
import com.yjc.snaphive.manager.websocket.disruptor.PictureEditEventProducer;
import com.yjc.snaphive.manager.websocket.model.PictureEditActionEnum;
import com.yjc.snaphive.manager.websocket.model.PictureEditMessageTypeEnum;
import com.yjc.snaphive.manager.websocket.model.PictureEditRequestMessage;
import com.yjc.snaphive.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    // 每张图片的编辑状态，key: pictureId, value: 当前正在编辑的用�?ID
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        // 获取消息内容，将 JSON 转换�?PictureEditRequestMessage
    ...
    private void broadcastToPicture(Long pictureId, PictureEditResponseMessage pictureEditResponseMessage, WebSocketSession excludeSession) throws IOException {
        ...
        if (CollUtil.isNotEmpty(sessionSet)) {
            ...
            // 配置序列化：�?Long 类型转为 String，解决丢失精度问�?
