...
import static com.yjc.snaphive.constant.UserConstant.USER_LOGIN_STATE;
import static com.yjc.snaphive.constant.CrawlerConstant.BAN_ROLE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    /**
     * 本项目中不使用。返回一个账号所拥有的角色标识集�?(权限与角色可分开校验)
     */
    @Override
