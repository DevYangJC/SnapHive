...
import com.yjc.snaphive.constant.CategoryConstant;
import com.yjc.snaphive.constant.UserConstant;
import com.yjc.snaphive.model.entity.Category;
import com.yjc.snaphive.model.vo.CategoryVO;
...
public class CategoryController {
    ...
    * @param type 分类类型�?-图片分类�?-帖子分类�?-音频分类�?
    * @return 分类列表（包含统计信息）
    */
   ...
   public BaseResponse<Boolean> addCategory(@RequestParam String categoryName,
      ...
      if (!Objects.equals(type, CategoryConstant.PICTURE_CATEGORY)
         ...
         return (BaseResponse<Boolean>) ResultUtils.error(40000, "分类类型不合�?);
      }
